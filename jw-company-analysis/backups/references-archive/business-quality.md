...
**"求"框架分析**（v3.61.8 新增，强制执行）：

> **"求"框架**：评估商业模式的可持续性和竞争壁垒，分为"三求"（最优）、"两求"、"一求"、"0求"（最差）。

**"求"框架定义**：
- **第一求：资源垄断求生存** — 拥有不可复制的稀缺资源（矿产/牌照/品牌/技术专利等）
- **第二求：成本优势求发展** — 成本处于行业/全球成本曲线左侧，具备定价权或抗周期能力
- **第三求：外部赋能求腾飞** — 获得政策/资源/资金/技术等外部赋能（央企背景/战略投资/技术授权等）

**"求"框架评分标准**：
- **三求**（最优）：22-25分 — 资源垄断+成本优势+外部赋能，商业模式极优
- **两求**：18-21分 — 具备其中两项，商业模式良好
- **一求**：14-17分 — 具备其中一项，商业模式一般
- **0求**（最差）：0-13分 — 不具备任何一项，商业模式存疑

**"求"框架写作模板**（填入报告"商业模式"章节）：
...
**"求"框架示例**（盐湖股份）：
- **第一求：资源垄断求生存** ✅ 察尔汗盐湖为中国最大可溶性钾镁盐矿床，钾肥产能500万吨为国内最大
- **第二求：成本优势求发展** ✅ 钾肥完全成本~1200-1500元/吨，锂~3-4.5万元/吨，均处于全球成本曲线左侧
- **第三求：央企赋能求腾飞** ✅ 五矿集团入主，"三步走"战略推动世界级盐湖产业基地建设
- **评分**：三求 → 22-25分（商业模式极优）
...
#### 护城河侵蚀因素分析（v3.61.1 新增）

> 评估护城河时，必须分析哪些因素可能侵蚀或摧毁护城河。这是逆向检查的核心。

**按护城河类型分类的侵蚀因素**：

| 护城河类型 | 主要侵蚀因素 | 典型案例 | 监控指标 |
|-----------|-------------|---------|---------|
| **品牌** | 品牌老化/负面事件/消费习惯变迁/新品牌崛起 | 诺基亚（品牌被iPhone颠覆）/ 三鹿（食品安全事件） | 品牌认知度/客户流失率/提价能力 |
| **成本优势** | 技术扩散/原材料涨价/规模不经济/新进入者更低成本 | 部分钢铁企业（技术被复制） | 单位成本趋势/毛利率变化/产能利用率 |
| **转换成本** | 技术标准化/数据可迁移/竞品降低迁移成本 | 企业软件（云迁移降低转换成本） | 客户流失率/合同续约率 |
| **网络效应** | 用户迁移/平台分裂/监管强制开放/新技术绕过 | MySpace（用户迁移到Facebook） | 用户活跃度/DAU/MAU趋势 |
| **牌照/监管** | 政策放开/监管收紧/牌照到期/新技术绕过监管 | 出租车（被网约车绕过） | 政策变化/牌照续期风险 |
| **规模效应** | 技术变革使规模不经济/需求碎片化/个性化趋势 | 传统媒体（被自媒体分流） | 市场份额/行业集中度 |
| **专利** | 专利到期/技术被绕过/专利诉讼失败 | 制药公司（专利悬崖） | 专利到期时间/后续管线 |

**系统性侵蚀因素（影响所有护城河）**：
- **技术颠覆**：新技术使现有护城河失效（如数码相机颠覆柯达）
- **监管变化**：政策放开或收紧改变竞争格局
- **消费习惯变迁**：用户偏好转移（如从线下到线上）
- **全球化竞争**：海外低成本竞争者进入
- **经济周期**：衰退期护城河被削弱（客户更敏感价格）

**护城河健康度检查清单**：
- [ ] 过去3年，护城河相关指标是否恶化？（毛利率/市占率/客户流失率）
- [ ] 是否有新技术/新模式可能绕过护城河？
- [ ] 竞争对手是否在侵蚀护城河？（差距是否缩小？）
- [ ] 管理层是否在维护/加深护城河？（研发投入/品牌建设）
- [ ] 护城河是否依赖单一因素？（多因素护城河更持久）
...
#### 管理层分析不足板块（v3.61.1 新增）

> 分析管理层时，必须明确指出分析的不足和局限性，避免过度自信。

**信息获取局限**：
- 致股东信/业绩会可能经过包装，不完全反映真实想法
- 内部人交易数据有滞后性（通常T+2披露）
- 管理层私下决策风格难以通过公开信息判断
- 国企管理层轮换频繁，历史表现参考价值有限

**量化指标局限**：
- ROIC计算依赖准确的资本投入数据（商誉/无形资产处理影响大）
- 管理层持股比例可能因股权激励计划而失真
- 并购整合效果需要3-5年才能完全显现
...
#### 影响后续成长性的因素分析（v3.61.1 新增）

> 评估成长性时，必须分析哪些因素可能影响未来增长的持续性和质量。

**正面驱动因素（增长加速器）**：

| 因素 | 影响机制 | 监控指标 | 典型案例 |
|------|---------|---------|---------|
| 行业渗透率提升 | 市场空间扩大，自然增长 | 渗透率/市场增速 | 新能源车渗透率从5%→30% |
| 产品升级/提价 | 提升客单价，毛利率改善 | ARPU/毛利率变化 | 茅台提价/苹果产品升级 |
| 新产品/新市场 | 打开第二增长曲线 | 新业务收入占比 | 亚马逊AWS/特斯拉储能 |
| 规模效应显现 | 单位成本下降，利润率提升 | 单位成本/毛利率 | 宁德时代产能扩张 |
| 技术突破 | 创造新需求或降低成本 | 研发转化率/专利数 | 英伟达AI芯片 |
| 政策支持 | 行业补贴/准入放宽 | 政策变化/补贴力度 | 新能源补贴/半导体大基金 |

**负面风险因素（增长减速器）**：

| 因素 | 影响机制 | 监控指标 | 典型案例 |
|------|---------|---------|---------|
| 市场饱和 | 渗透率见顶，增长放缓 | 渗透率/行业增速 | 智能手机渗透率>90% |
| 竞争加剧 | 价格战/份额流失 | 市占率/毛利率变化 | 光伏行业价格战 |
| 技术替代 | 新技术使现有产品过时 | 技术路线变化 | 功能机被智能机替代 |
| 政策收紧 | 补贴退坡/监管加强 | 政策变化/合规成本 | 新能源补贴退坡 |
| 原材料涨价 | 成本上升侵蚀利润 | 原材料价格/毛利率 | 锂矿价格暴涨 |
| 管理层变动 | 战略方向可能改变 | 高管离职/新CEO上任 | 乔布斯离开苹果 |
| 国际化风险 | 海外市场拓展不及预期 | 海外收入占比/汇率 | 贸易战/制裁 |
| 周期性因素 | 行业景气度下行 | 产能利用率/库存周期 | 面板/存储芯片周期 |

**成长性可持续性检查清单**：
- [ ] 增长来源是否多元化？（不依赖单一因素）
- [ ] 增长是否有护城河保护？（竞争对手难以复制）
- [ ] 增长是否消耗过多资本？（ROIC是否>WACC）
- [ ] 增长是否有天花板？（市场空间/渗透率）
- [ ] 管理层是否有能力支撑增长？（执行力/战略清晰度）
- [ ] 增长是否可持续3-5年？（非一次性因素驱动）

**如何在报告中呈现**：
1. 列出影响公司成长性的3-5个关键因素（正面+负面）
2. 评估每个因素的概率和影响程度
3. 给出成长性可持续性的综合判断
4. 标注需要持续监控的指标和时间节点
