...
def build_plan(clusters: dict[str, Any], scores: dict[str, Any]) -> dict[str, Any]:
    ...
    for idx, (pscore, cl, meta) in enumerate(ranked, 1):
        ...
        if idx <= 10 and meta["best_grade"] in ("A", "B") and meta["avg_score"] >= 65:
    ...
    return {
        ...
        "decision_policy": "Top 10 A/B clusters enter recommended_units; B/C clusters go to appendix; D/low-score clusters go to excluded_or_weak.",
