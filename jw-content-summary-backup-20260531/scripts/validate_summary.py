...
def count_chinese_chars(text: str) -> int:
    """Count CJK characters + punctuation, stripping whitespace and markdown."""
...
def check_summary(path: str) -> list[str]:
    ...
    if not r_citations and not r_ch_citations and not r_ch_slash_citations:
