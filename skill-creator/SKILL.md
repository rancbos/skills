...
When asked to review or audit an existing skill, use the systematic checklist in `references/skill-audit-checklist.md`. It covers 9 categories of issues: logical conflicts, step ordering, absolute thresholds, missing data sources, vague thresholds, orphaned sections, self-check mapping, template/flow disconnect, and description triggering. Each category has detection signals and concrete fixes.
