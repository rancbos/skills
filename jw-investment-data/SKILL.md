...
uv pip install baostock akshare yfinance --python ~/.hermes/skills/jw-investment-data/.venv/bin/python -i https://pypi.tuna.tsinghua.edu.cn/simple

# 安装后用 venv python 调用脚本
~/.hermes/skills/jw-investment-data/.venv/bin/python technical_indicators.py --symbol 600519 --format markdown
```
