...
- 思维模型 / 推理结构 → `extractors/framework-extractor.md`
- 作者亲自用过的案例 → `extractors/case-extractor.md`
- 反例 / 警告的失败模式 → `extractors/counter-example-extractor.md`
- 术语 → `extractors/glossary-extractor.md`
