...
- 方法论框架/推理结构 → `extractors/framework-extractor.md`
- 原则/规则/清单 → `extractors/principle-extractor.md`
- 案例/反例 → `extractors/case-extractor.md` / `extractors/counter-example-extractor.md`
- 一般词汇（全书<3次、无作者特定用法）→ 不收
