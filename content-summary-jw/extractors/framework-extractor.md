...
- 原则 / 清单 / 规则 → `extractors/principle-extractor.md`
- 作者亲自用过的具体案例 → `extractors/case-extractor.md`
- 失败模式 / 反例 / 警告 → `extractors/counter-example-extractor.md`
- 术语定义 → `extractors/glossary-extractor.md`

边界模糊时**宁可多提取**,阶段 3 会去重合并。
